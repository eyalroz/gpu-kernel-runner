...
//
// This file is a modified version of <type_traits>, which itself
// is part of the GNU ISO C++ Library.  This file is free
...
// The GNU General Public License and the GCC Runtime Library Exception
// can be found at <http://www.gnu.org/licenses/>.

/** @file type_traits_for_nvrtc.hpp
 *  A modification of GCC 7.4.1's type_traits for use with NVRTC.
 */

#ifndef _NVRTC_TYPE_TRAITS
#define _NVRTC_TYPE_TRAITS 1

#if __cplusplus < 201103L
#error "Please compile this file using language standard C++11 or later"
#endif

#include "nvrtc_int_type_macros.h"

// instead-of #include <bits/c++config.h> :
//--------------------------------------------
...
//--------------------------------------------
// end-of instea-of #include <bits/c++config.h>
...
// Note: the following has been switched from 201402L
// due to NVRTC complaint when using std::true_type and std::false_type
#if __cplusplus >= 201703L
  /// is_swappable_v
  template<typename _Tp>
