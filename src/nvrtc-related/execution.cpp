...
void initialize_execution_context<execution_ecosystem_t::cuda>(execution_context_t& execution_context)
{
    ...
    execution_context.l2_cache_size = execution_context.options.clear_l2_cache ?
        execution_context.cuda.context->device().get_attribute(CU_DEVICE_ATTRIBUTE_L2_CACHE_SIZE) : 0;
